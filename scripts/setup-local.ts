...
function main(): void {
  ...
  console.log('   npm run dev            # API :3000 + Web :5173 (development)');
  console.log('   npm run build && npm start   # production (single process :3000)');
  console.log('\nOpen http://localhost:5173 in development, or http://localhost:3000 in production.');
  console.log('\nDemo logins (seeded):');
